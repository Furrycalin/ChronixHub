...
local basicTab = mainWindow:CreateTab({ Name = "基础设置", HasIcon = true, IconName = "pencil-ruler", IconColor = Color3.fromRGB(255, 255, 255) })
...
local ToolsTab = mainWindow:CreateTab({ Name = "工具", HasIcon = true, IconName = "wrench", IconColor = Color3.fromRGB(255, 255, 255) })
...
local playerteleporterTab = mainWindow:CreateTab({ Name = "玩家传送", HasIcon = true, IconName = "contact-round", IconColor = Color3.fromRGB(255, 255, 255) })
...
local waypointTab = mainWindow:CreateTab({ Name = "路径点传送", HasIcon = true, IconName = "map-pinned", IconColor = Color3.fromRGB(255, 255, 255) })
local waypointsData = {}
...
local musicTab = mainWindow:CreateTab({ Name = "音乐播放器", HasIcon = true, IconName = "music", IconColor = Color3.fromRGB(255, 255, 255) })
...
local audioCheckerTab = mainWindow:CreateTab({ Name = "音频检查器", HasIcon = true, IconName = "audio-waveform", IconColor = Color3.fromRGB(255, 255, 255) })
...
local chatReceiverTab = mainWindow:CreateTab({ Name = "聊天接收器", HasIcon = true, IconName = "messages-square", IconColor = Color3.fromRGB(255, 255, 255) })
local chatMessages = {}
...
local filterTab = mainWindow:CreateTab({ Name = "滤镜控制器", HasIcon = true, IconName = "sparkles", IconColor = Color3.fromRGB(255, 255, 255) })
...
local supportedgamesTab = mainWindow:CreateTab({ Name = "支持的游戏", HasIcon = true, IconName = "swords", IconColor = Color3.fromRGB(255, 255, 255) })
...
for _, GetgameInfo in ipairs(data.Supported_Games) do
    if GetgameInfo.gameid == game.GameId then
        local OtherGameTab = mainWindow:CreateTab({ Name = GetgameInfo.name, HasIcon = true, IconName = "gamepad-2", IconColor = Color3.fromRGB(255, 255, 255) })
...
local infoTab = mainWindow:CreateTab({ Name = "关于", HasIcon = true, IconName = "info", IconColor = Color3.fromRGB(255, 255, 255) })
